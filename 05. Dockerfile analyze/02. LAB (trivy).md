...
```sh
trivy config --exit-code 1 --serverity HIGH --misconfig-scanners=dockerfile Dockerfile 
```
...
```sh
trivy config --exit-code 1 --serverity CRITICAL --misconfig-scanners=dockerfile Dockerfile 
```
